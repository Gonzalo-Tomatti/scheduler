...
//https://backend-scheduler-production.up.railway.app/
...
export const GlobalProvider = ({ children }) => {
  ...
  const signUp = (e) => {
    ...
    if (
      ...
      axios
        .post(
          "https://backend-scheduler-production.up.railway.app/signup",
          user
        )
        .then((res) => {
  ...
  const logIn = (e) => {
    ...
    if (user.email === "" || user.password === "") {
      ...
      axios
        .post(`https://backend-scheduler-production.up.railway.app/login`, user)
        .then((res) => {
  ...
  const postSchedule = () => {
    ...
    axios
      .post(
        "https://backend-scheduler-production.up.railway.app/post-schedule",
        newSchedule
      )
      .then((res) => {
